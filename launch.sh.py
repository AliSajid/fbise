...
command_string = "/d/Program\ Files/Docker\ Toolbox/docker run --detach -v /d/experiments/fbise/data:/app/fbise/data -v /d/experiments/fbise/logs:/app/logs --name worker{:0>2} localhost:5000/fbise /opt/conda/bin/python /app/fbise/downloader.py -s {} -e {} -l {} -p {} -t {}"
